...
const Contact = () => {
  ...
  const contactInfo = [
    {
      ...
      title: 'Email',
      value: 'amarfiqih715@gmail.com',
      link: 'mailto:amarfiqih715@gmail.com',
    },
    {
      icon: <Phone className="w-6 h-6" />,
      title: 'Phone',
      value: '+62 831902092033',
      link: 'tel:+6283190292033',
    },
    {
  ...
  const socialLinks = [
    { icon: <Github className="w-6 h-6" />, link: 'https://github.com/amar23-dev', name: 'GitHub' },
    { icon: <Linkedin className="w-6 h-6" />, link: 'https://www.linkedin.com/in/amar-fiqih-460aaa279/?lipi=urn%3Ali%3Apage%3Ad_flagship3_feed%3B7fY7j1iVSkKf5RuwgKgjvA%3D%3D', name: 'LinkedIn' },
    { icon: <Instagram className="w-6 h-6" />, link: 'https://www.instagram.com/amar.fiqih/', name: 'Instagram' },
  ];
